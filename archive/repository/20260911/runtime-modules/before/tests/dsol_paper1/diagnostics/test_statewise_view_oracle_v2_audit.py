...
from scripts.dsol_paper1.audit_statewise_view_oracle_v2_run import audit
from scripts.dsol_paper1.evaluate_dsol_libero_hdf5_views import protocol_spec_at
from scripts.dsol_paper1.explicit_flow_noise import materialize_bank, tensor_sha256
                ...
                "policy_calls": [
                    {
                        ...
                        "noise_seed": int(
                            __import__(
                                "scripts.dsol_paper1.explicit_flow_noise",
