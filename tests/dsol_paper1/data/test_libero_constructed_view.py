...
SCRIPT_ROOT = REPOSITORY_ROOT / "scripts" / "dsol_paper1"
SHARED_ROOT = REPOSITORY_ROOT / "scripts" / "vla_shared"
sys.path[:0] = [str(SCRIPT_ROOT), str(SHARED_ROOT)]

from scripts.dsol_paper1.runtime.libero_constructed_view import CONSTRUCTION_SCHEMA, explicit_task_orbit_pose, inject_static_visual_occluder, paired_task_orbit_poses, task_orbit_pose_from_specification
