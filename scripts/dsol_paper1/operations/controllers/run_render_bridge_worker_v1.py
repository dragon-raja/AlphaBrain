...
from scripts.dsol_paper1.runtime.render_bridge_common_v1 import ROOT, RUNTIME, REPO, read, sha, write_new, array_identity, render_protocol
...
def render(args,release):
    import h5py
    from scripts.dsol_paper1.runtime.audit_libero_hdf5_restore import _decode, _rewrite_model_paths
    from scripts.dsol_paper1.runtime.run_view_value_expectation_accel_ensemble import operational_records
