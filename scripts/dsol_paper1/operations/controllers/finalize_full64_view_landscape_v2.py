...
from scripts.dsol_paper1.operations.controllers.run_full64_view_landscape_v2 import ROOT, PARENT, REPO, preflight, verify_first_eight, completed, require
...
def main():
    ...
    subprocess.run([sys.executable,str(REPO/'reports/paper1/historical/build_view_landscape_report_v1.py'),
    ...
    subprocess.run([sys.executable,str(REPO/'scripts/dsol_paper1/analysis/analyze_view_oracle_comparison_v2.py'),
