...
from scripts.dsol_paper1.analysis.analyze_view_metric_rules_v1 import analyze, source_bootstrap, RULES
from reports.paper1.historical.build_view_landscape_report_v1 import read_json, write_json, write_csv, sha256, require, finite_json, setup_plotting
from scripts.dsol_paper1.analysis.compare_matched_view_landscapes_v1 import CHECKPOINTS, CONFIGS, SOURCE_FIELDS, ASSET_HASH_FIELDS, GEOMETRY_FIELDS, BANK_MANIFEST_SHA256
from reports.paper1.historical.build_view_metric_comparison_brief_v1 import RULE_LABELS
...
def main():
    ...
    write_json(args.output_dir/'manifest.json',dict(schema='dsol_metric_oracle_manifest_v2',status='FROZEN_BEFORE_ORACLE_AGGREGATION',
        ...
        script_sha256=sha256(Path(__file__)),metric_core_sha256=sha256((_REPOSITORY_ROOT / 'scripts/dsol_paper1/analysis/analyze_view_metric_rules_v1.py')),
