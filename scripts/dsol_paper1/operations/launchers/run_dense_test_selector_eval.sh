...
SUMMARIZER=$REPO_ROOT/scripts/dsol_paper1/analysis/summarize_dense_test_selectors.py
PLOTTER=$REPO_ROOT/scripts/dsol_paper1/analysis/plot_dense_test_selectors.py
