...
from analyze_view_oracle_comparison_v2 import load_verified, paired_training_rows, LABELS, ORACLES
from analyze_view_metric_rules_v1 import RULES
from build_view_landscape_report_v1 import read_json, write_json, sha256, ranks, setup_plotting, require, PARAMS
from build_view_metric_comparison_brief_v1 import camera_centers
...
def build():
    ...
    unified=REPO/'scripts/dsol_paper1/build_unified_research_progress_v1.py'
