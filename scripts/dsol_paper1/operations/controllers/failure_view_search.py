...
if __package__:
    from scripts.dsol_paper1.analysis.analyze_view_value_discovery import atomic_json, flatten_row, pairwise_auc
    from scripts.dsol_paper1.protocols.build_view_repeatability_protocols import normalized_pose_distance
    from scripts.dsol_paper1.protocols.expand_protocol_noise_repeats import build as repeat_protocol
else:
    from scripts.dsol_paper1.analysis.analyze_view_value_discovery import atomic_json, flatten_row, pairwise_auc
    from scripts.dsol_paper1.protocols.build_view_repeatability_protocols import normalized_pose_distance
    from scripts.dsol_paper1.protocols.expand_protocol_noise_repeats import build as repeat_protocol
