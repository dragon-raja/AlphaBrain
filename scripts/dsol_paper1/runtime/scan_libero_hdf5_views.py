...
def scan(args: argparse.Namespace) -> dict[str, Any]:
    ...
    script_root = (_REPOSITORY_ROOT / 'scripts/dsol_paper1')
    ...
    from scripts.dsol_paper1.runtime.libero_constructed_view import inject_static_visual_occluder, install_constructed_camera_pose, paired_task_orbit_poses, resolve_static_visual_occluder
