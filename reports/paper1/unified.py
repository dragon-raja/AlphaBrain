...
import sys as _sys
_REPOSITORY_ROOT = _RepoPath(__file__).resolve().parents[2]
...
from scripts.dsol_paper1.reporting.build_view_research_focus_brief import Brief, INK, MUTED, BLUE, TEAL, GRAY, AMBER
from reports.paper1.historical.build_view_landscape_report_v1 import read_json, write_json, sha256, require
...
def build():
    ...
    if initial_latest.exists():
        from scripts.dsol_paper1.reporting.report_standard_initial_results_v1 import build as build_current
