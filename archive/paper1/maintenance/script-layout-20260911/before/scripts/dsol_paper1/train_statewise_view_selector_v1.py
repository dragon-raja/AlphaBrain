...
try:
    from .build_statewise_view_oracle_v2 import (
        freeze_json,
        load_scan_assets,
        operational_candidates,
    )
    from .build_statewise_view_oracle_v2_stage import (
        matched_paths,
        summarize_ledgers,
        validate_input_audits,
    )
    from .explicit_flow_noise import sha256_file
except ImportError:  # Direct script execution.
    from build_statewise_view_oracle_v2 import freeze_json, load_scan_assets, operational_candidates
    from build_statewise_view_oracle_v2_stage import (
        matched_paths,
        summarize_ledgers,
        validate_input_audits,
