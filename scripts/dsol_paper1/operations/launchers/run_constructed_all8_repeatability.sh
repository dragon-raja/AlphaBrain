...
BUILDER=$REPO_ROOT/scripts/dsol_paper1/protocols/build_view_repeatability_protocols.py
...
PLOTTER=$REPO_ROOT/scripts/dsol_paper1/analysis/plot_view_repeatability.py
