...
def build(v2_root: Path, output_root: Path, *, salt: str = DEFAULT_SALT) -> dict[str, Any]:
    ...
    provenance = {
        ...
        "implementation": [source_identity(scripts_dir / name) for name in (
            "scripts/dsol_paper1/protocols/build_matched_view_landscape_protocol_v1.py",
            "scripts/dsol_paper1/runtime/evaluate_dsol_libero_hdf5_views.py",
            "AlphaBrain/research/dsol/data/flow_noise.py",
            "scripts/dsol_paper1/operations/launchers/run_dsol_libero_hdf5_closed_loop_eval.sh",
            "scripts/dsol_paper1/diagnostics/audit_statewise_view_oracle_v2_run.py",
        )],
