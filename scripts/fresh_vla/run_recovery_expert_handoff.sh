...
OUTPUT_ROOT=${FRESH_HANDOFF_ROOT:-/share/longjunyu/fresh-vla/research-reset/recovery-expert-handoff-v2}
...
TOTAL_ACTION_BUDGET=${FRESH_HANDOFF_TOTAL_ACTION_BUDGET:-320}
MAX_TEACHER_ACTIONS=${FRESH_HANDOFF_MAX_TEACHER_ACTIONS:-320}
