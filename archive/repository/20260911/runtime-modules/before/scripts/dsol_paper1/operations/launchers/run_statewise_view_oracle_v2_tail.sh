...
/alphabrain/.venv/bin/python "$REPO_ROOT/scripts/dsol_paper1/protocols/build_statewise_view_oracle_v2_stage.py" \
...
/alphabrain/.venv/bin/python "$REPO_ROOT/scripts/dsol_paper1/training/train_statewise_view_selector_v1.py" \
...
/alphabrain/.venv/bin/python "$REPO_ROOT/scripts/dsol_paper1/analysis/analyze_statewise_view_oracle_v2.py" \
...
if [[ "$reserve_status" == "ACTIVATE_R" ]]; then
  ...
  /alphabrain/.venv/bin/python \
    "$REPO_ROOT/scripts/dsol_paper1/protocols/clone_statewise_view_oracle_v2_reserve.py" \
