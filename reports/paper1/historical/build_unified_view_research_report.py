...
def main():
    ...
    protected=[ROOT/"docs/dsol_paper1/reports/archive/imported/view_revalidation_stage1_integrated_v5_20260826_zh.pdf",ROOT/"docs/dsol_paper1/reports/archive/imported/view_value_new_experiments_zh.pdf"]
