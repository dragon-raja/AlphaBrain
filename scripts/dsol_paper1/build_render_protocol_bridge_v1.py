...
from render_bridge_common_v1 import ROOT,REPO,read,sha,write_new,cell_key
from evaluate_dsol_libero_hdf5_views import protocol_spec_at,protocol_spec_count
import run_full64_view_landscape_v2 as old_control
...
def build():
    ...
    source_paths += [REPO/'scripts/dsol_paper1'/name for name in ('render_bridge_common_v1.py','run_render_bridge_worker_v1.py',
        'build_render_protocol_bridge_v1.py','run_render_protocol_bridge_v1.py','queue_render_protocol_bridge_v1.py','analyze_render_protocol_bridge_v1.py')]
    for state in states:
