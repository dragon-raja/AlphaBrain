...
try:
    ...
    from scripts.dsol_paper1.operations.controllers.constructed_blind_reveal import REQUIRED_ROLES, VISIBILITY_DEFINITION, build_snapshot_identity, check_record_visibility, is_sha256, role_index, sha256_file
