...
"$SIM_PYTHON" "$REPO_ROOT/scripts/dsol_paper1/protocols/build_libero_visibility_scan_plan.py" \
  --pair-root "$PAIR_ROOT" \
...
"$SIM_PYTHON" "$REPO_ROOT/scripts/dsol_paper1/protocols/build_strong_information_gate_plan.py" \
...
"$SIM_PYTHON" "$REPO_ROOT/scripts/dsol_paper1/protocols/build_constructed_view_oracle_protocol.py" \
...
"$SIM_PYTHON" "$REPO_ROOT/scripts/dsol_paper1/protocols/build_dense_test_scan_plan.py" \
...
"$ANALYSIS_PYTHON" "$REPO_ROOT/scripts/dsol_paper1/protocols/build_dense_test_selector_protocol.py" \
...
"$ANALYSIS_PYTHON" "$REPO_ROOT/scripts/dsol_paper1/protocols/expand_protocol_noise_repeats.py" \
...
"$ANALYSIS_PYTHON" "$REPO_ROOT/scripts/dsol_paper1/analysis/summarize_dense_test_selectors.py" \
  "$RUN_ROOT"/run-five-noise/episodes-shard-*.jsonl \
  --expected-repeats "$NOISE_REPEATS" \
  --output-dir "$RUN_ROOT/analysis"
"$ANALYSIS_PYTHON" "$REPO_ROOT/scripts/dsol_paper1/analysis/plot_dense_test_selectors.py" \
