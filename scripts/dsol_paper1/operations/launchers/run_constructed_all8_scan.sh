...
SCANNER=$REPO_ROOT/scripts/dsol_paper1/operations/launchers/run_libero_visibility_scan_matrix.sh
FREEZER=$REPO_ROOT/scripts/dsol_paper1/protocols/freeze_constructed_task_pairs.py
DENSE_BUILDER=$REPO_ROOT/scripts/dsol_paper1/protocols/build_constructed_view_oracle_protocol.py
