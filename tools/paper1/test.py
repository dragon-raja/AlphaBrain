...
def main():
    ...
    paths = [ROOT, ROOT / "scripts/dsol_paper1", ROOT / "scripts/vla_shared", ROOT / "tests/dsol_paper1"]
    env["PYTHONPATH"] = os.pathsep.join(map(str, paths))
    return subprocess.call(
        [sys.executable, "-m", "pytest", str(ROOT / "tests/dsol_paper1"), str(ROOT / "tests/vla_shared"),
