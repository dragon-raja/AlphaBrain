...
import numpy as np
import scripts.dsol_paper1.operations.controllers.dualhost_aa0_v1 as core
from scripts.dsol_paper1.runtime.standard_initialization_v1 import KIND, load_initial, initialize
...
def build():
    import re
    import torch
    from AlphaBrain.research.dsol.data.flow_noise import materialize_bank, stable_uint64
