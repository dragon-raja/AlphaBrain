...
from scripts.dsol_paper1.protocols.build_matched_view_landscape_protocol_v1 import DEFAULT_V2_ROOT, DEFAULT_OUTPUT_ROOT, EXPECTED_CANDIDATES, read_json, write_new_json, source_identity, object_sha256
from scripts.dsol_paper1.runtime.evaluate_dsol_libero_hdf5_views import protocol_spec_at, protocol_spec_count
from scripts.dsol_paper1.runtime.run_matched_view_accel_v1 import validate_assets, code_identities
...
def build(root=ROOT):
    ...
    scripts = ['scripts/dsol_paper1/protocols/build_full64_view_landscape_v2.py',
               'scripts/dsol_paper1/operations/controllers/run_full64_view_landscape_v2.py',
               'scripts/dsol_paper1/operations/controllers/finalize_full64_view_landscape_v2.py',
               'scripts/dsol_paper1/analysis/analyze_view_oracle_comparison_v2.py']
    code = [source_identity(REPO/name) for name in scripts]
    code += [source_identity(REPO/name) for name in (
        'reports/paper1/historical/build_view_landscape_report_v1.py',
        'scripts/dsol_paper1/analysis/analyze_view_metric_rules_v1.py',
        'scripts/dsol_paper1/analysis/compare_matched_view_landscapes_v1.py',
        'reports/paper1/historical/build_view_metric_comparison_brief_v1.py')]
