...
ANALYZER = REPO / "scripts/dsol_paper1/analysis/summarize_dsol_libero_hdf5_closed_loop.py"
ACTIVE = None
STOPPED = False
...
def runner_code_hash():
    ...
    paths = [REPO / "scripts/cabi_vla/serve_alphabrain_pi05_websocket.py",
             ...
             REPO / "scripts/dsol_paper1/runtime/evaluate_dsol_libero_hdf5_views.py", ANALYZER, RUNNER]
...
def preflight():
    ...
    from scripts.dsol_paper1.runtime.evaluate_dsol_libero_hdf5_views import protocol_spec_count, protocol_spec_at
    seen = set()
    for part in route:
    ...
    identity = {"release_sha256": sha(RELEASE), "protocol_manifest_sha256": release["protocol_manifest"]["sha256"],
                "controller_sha256": sha(REPO / "scripts/dsol_paper1/operations/launchers/run_matched_view_landscape_v1.sh"),
