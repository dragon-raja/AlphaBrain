...
import reports.paper1.historical.build_view_revalidation_report_pdf as report
...
def main():
    ...
    parser.add_argument(
        "--output", type=Path, default=report.ROOT / "docs/dsol_paper1/reports/archive/imported/view_value_new_experiments_zh.pdf"
    )
