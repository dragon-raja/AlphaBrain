...
try:
    ...
    from scripts.dsol_paper1.operations.controllers.constructed_blind_reveal import build_snapshot_identity, masked_visibility, recompute_equal_weight_visibility, sha256_file
