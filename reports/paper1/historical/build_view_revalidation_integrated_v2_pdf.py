...
import reports.paper1.historical.build_accel_expanded_brief_pdf as expanded
import reports.paper1.historical.build_view_revalidation_brief_pdf as base


ROOT = Path(__file__).resolve().parents[3]
DEFAULT_OUTPUT = (
    ROOT
    / "docs/dsol_paper1/reports/archive/imported/view_revalidation_stage1_integrated_v2_20260825_zh.pdf"
)
