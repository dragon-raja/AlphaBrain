...
from scripts.dsol_paper1.runtime.run_view_value_expectation_accel_ensemble import append_jsonl, rank_state, sha256_file, stable_seed
...
def code_identities() -> list[dict[str, Any]]:
    paths = [Path(__file__), (_REPOSITORY_ROOT / 'scripts/dsol_paper1/runtime/run_view_value_expectation_accel_ensemble.py'),
             (_REPOSITORY_ROOT / 'AlphaBrain/research/dsol/metrics/accel_inference.py'), (_REPOSITORY_ROOT / 'AlphaBrain/research/dsol/metrics/accel.py'),
