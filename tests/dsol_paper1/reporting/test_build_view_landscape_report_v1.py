...
from reports.paper1.historical.build_view_landscape_report_v1 import catalog_bank, clustered_summary, load_dense, ranks, read_json, sha256, spearman, state_metrics, wilson
...
class ViewLandscapeTests(unittest.TestCase):
    ...
    def test_partial_dense_includes_smoke_and_remainder_and_rejects_holes(self):
        config = REPOSITORY_ROOT / 'configs/dsol_paper1'
